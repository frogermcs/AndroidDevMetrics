...
public class MetricDescription extends MetricDescriptionTreeItem {
    ...
    private int getWarningLevel(long initTimeWithoutArgs) {
        if (initTimeWithoutArgs < Dagger2Metrics.WARNING_1_LIMIT_MILLIS) {
            return 0;
        } else if (initTimeWithoutArgs < Dagger2Metrics.WARNING_2_LIMIT_MILLIS) {
            return 1;
        } else if (initTimeWithoutArgs < Dagger2Metrics.WARNING_3_LIMIT_MILLIS) {
            return 2;
        } else {
            return 3;
        }
